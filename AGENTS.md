...
- **Do not commit or push after every individual change.** Accumulate changes across a round of work, then wrap them into one tidy commit (and push) at the end, or when explicitly asked.
